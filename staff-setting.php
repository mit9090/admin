...
<!-- Mirrored from preclinic.dreamguystech.com/template/staff-setting.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 12:40:02 GMT -->
<head>
<meta charset="utf-8">
...
<ul class="nav">
<li>
<a href="staff-profile.html"><span class="set-about-icon me-2"><img src="assets/img/icons/menu-icon-02.svg" alt></span>About me</a>
</li>
<li>
<a href="staff-setting.html" class="active"><span class="set-about-icon me-2"><img src="assets/img/icons/menu-icon-16.svg" alt></span>Settings</a>
</li>
</ul>
</div>
...
<input class="form-control" type="text" value="cristina@29">
</div>
</div>
<div class="col-12 col-sm-12">
<div class="form-group local-forms">
...
<div class="form-group local-forms">
<label>Email </label>
<input class="form-control" type="email" value="cristina@info.com">
</div>
</div>
<div class="col-12 col-sm-12">
<div class="form-group local-forms">
...
<label class="custom_check mr-2 mb-0 d-inline-flex remember-me"> Profile Visibility For Everyone
<input type="checkbox" name="radio" checked>
<span class="checkmark"></span>
</label>
</div>
<div class="remember-me">
<label class="custom_check mr-2 mb-0 d-inline-flex remember-me"> New task notifications
<input type="checkbox" name="radio" checked>
<span class="checkmark"></span>
</label>
</div>
<div class="remember-me">
<label class="custom_check mr-2 mb-0 d-inline-flex remember-me"> New friend request notifications
