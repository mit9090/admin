...
<!-- Mirrored from preclinic.dreamguystech.com/template/edit-patient.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Sep 2023 12:37:07 GMT -->
<head>
<meta charset="utf-8">
...
<li><a class="active" href="edit-patient.html">Edit Patients</a></li>
...
<div class="form-check-inline">
<label class="form-check-label">
<input type="radio" name="gender1" class="form-check-input" checked>Active
</label>
</div>
<div class="form-check-inline">
<label class="form-check-label">
<input type="radio" name="gender1" class="form-check-input">In Active
</label>
</div>
</div>
</div>
